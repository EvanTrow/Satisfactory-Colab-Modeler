...
| Clock speed   | Numeric field plus **± buttons that step through a fixed list of preset percentages** (1, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250 — minus steps down, plus steps up).                                                     |
